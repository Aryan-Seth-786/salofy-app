function renderOTP() {
  ...
  return Shell(`
    <div style="padding:60px 24px 24px">
      ...
      <div style="font-size:15px;color:${C.text2};margin-bottom:36px;line-height:1.5">We sent a 6-digit code to <span style="font-weight:600;color:${C.text}">+91 98765 43210</span></div>
      ...
      <button data-action="go-onboarding" class="btn btn--primary">Verify & Continue</button>

      <div style="text-align:center;margin-top:20px;font-size:15px;color:${C.text3}">
