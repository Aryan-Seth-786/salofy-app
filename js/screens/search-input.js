function renderSearchInput() {
  ...
  return Shell(`
    ...
    <div style="padding:12px 20px 0">
      <div style="font-size:11px;font-weight:800;color:${C.primary};text-transform:uppercase;letter-spacing:0.1em;margin-bottom:8px">Selected (${selSvcs.length})</div>
    ...
    <div style="padding:16px 20px 8px">
      <div style="font-size:11px;font-weight:800;color:${C.text3};text-transform:uppercase;letter-spacing:0.1em;margin-bottom:10px">Recent Searches</div>
      ${recent.map(r => `
        <div style="display:flex;align-items:center;gap:10px;padding:10px 0;border-bottom:1px solid ${C.borderS};cursor:pointer">
          ...
          <span style="font-size:15px;color:${C.text2};flex:1">${r}</span>
    ...
    <div style="padding:4px 0 8px">
      <div style="padding:0 20px;display:flex;align-items:center;justify-content:space-between;margin-bottom:10px">
        <div style="font-size:11px;font-weight:800;color:${C.text3};text-transform:uppercase;letter-spacing:0.1em">Popular Packages</div>
        <div style="font-size:12px;color:${C.primary};font-weight:600">Bundle &amp; save</div>
      </div>
    ...
    <div style="padding:8px 20px 100px">
      <div style="font-size:11px;font-weight:800;color:${C.text3};text-transform:uppercase;letter-spacing:0.1em;margin-bottom:10px">All Services</div>
